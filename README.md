...
[![Ministry of Justice Repository Compliance Badge](https://github-community.service.justice.gov.uk/repository-standards/api/hmpps-approved-premises-manage-a-resident-api/badge?style=flat)](https://github-community.service.justice.gov.uk/repository-standards/hmpps-approved-premises-manage-a-resident-api)
[![Docker Repository on ghcr](https://img.shields.io/badge/ghcr.io-repository-2496ED.svg?logo=docker)](https://ghcr.io/ministryofjustice/hmpps-approved-premises-manage-a-resident-api)
[![API docs](https://img.shields.io/badge/API_docs_-view-85EA2D.svg?logo=swagger)](https://approved-premises-manage-a-resident-api-dev.hmpps.service.justice.gov.uk/swagger-ui/index.html)
...
Our security policy is located [here](https://github.com/ministryofjustice/hmpps-approved-premises-manage-a-resident-api/security/policy).
...
## Renaming from HMPPS Approved Premises Manage A Resident Api - github Actions
...
```bash
docker compose pull && docker compose up --scale hmpps-approved-premises-manage-a-resident-api=0
```
